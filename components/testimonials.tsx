...
const testimonials = [
  ...
  },
  {
    ...
    company: "Forbes Inc.",
    content:
      "I've never been a fan of complicated website AI tools, which is why LoadIQ is perfect for me. Its minimalist design and simple functionality make staying organized feel like second nature.",
    categories: [1, 4],
  },
  {
        ...
        <div>
          ...
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
            <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1">
              ...
              >
                <svg
                  className={`fill-current ${category === 1 ? "text-indigo-400" : "text-gray-600"}`}
              ...
              >
                <svg
                  className={`fill-current ${category === 2 ? "text-indigo-400" : "text-gray-600"}`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
                >
              ...
              >
                <svg
                  className={`fill-current ${category === 3 ? "text-indigo-400" : "text-gray-600"}`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
                >
              ...
              >
                <svg
                  className={`fill-current ${category === 4 ? "text-indigo-400" : "text-gray-600"}`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
                >
              ...
              >
                <svg
                  className={`fill-current ${category === 5 ? "text-indigo-400" : "text-gray-600"}`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
                >
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <p className="text-gray-300 before:content-['“'] after:content-['”']">
          {children}
        </p>
